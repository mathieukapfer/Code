...
int main(int argc, char* argv[]) {
    ...
    const int n = 100 ;// 8*32*512;             // size of vectors
    const int k = 1; //0000;                // number of loop iterations
    ...
    cl::Kernel add_looped_2 = cl::Kernel(program, "add_lopper_2");
    cl::Kernel add_single   = cl::Kernel(program, "add");
